-- Recreate leads_full so bride_leads intake columns (confirmation_*, last_progress_follow_up_at) are visible.
-- PostgreSQL expands bl.* at view creation time; ALTER TABLE on bride_leads does not update the view.
